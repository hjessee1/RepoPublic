    ...
    *  in HP Service Test.
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            _flow.RESTActivityV24.Input.Date =  new DateTime(2025,12,31,0,0,0,0);
...
@"<RequestMultipartInfo><Type>Related</Type></RequestMultipartInfo>");
            ...
            _flow.RESTActivityV24.Input.ArrivalCity = @"Paris";
            _flow.RESTActivityV24.Input.Date =  new DateTime(2025,12,31,0,0,0,0);
            VTDPropertyInfoBase pi1 = new VTDPropertyInfoBase("Input.DepartureCity");
            ...
            binding_setter1 = new StringFormaterDecorator(binding_setter1,"{Step.RESTInputProperties.RESTActivityV24.DepartureCity}");
            ...
            VTDPropertyInfoBase pi3 = new VTDPropertyInfoBase("Input.ArrivalCity");
            VTDBaseGetter binding_getter2 = new VTDObjectGetter(pi3);
            VTDPropertyInfoBase pi4 = new VTDPropertyInfoBase("Url");
            VTDBaseSetter binding_setter2 = new VTDObjectSetter(pi4);
            binding_setter2 = new StringFormaterDecorator(binding_setter2,"{Step.RESTInputProperties.RESTActivityV24.ArrivalCity}");
            bind_dir2 = new BindDirection(_flow.RESTActivityV24,binding_getter2,binding_setter2,BindTargetType.ToInProperty);
            _flow.RESTActivityV24.InDirections.Add(bind_dir2);
            VTDPropertyInfoBase pi5 = new VTDPropertyInfoBase("Input.Date");
            VTDBaseGetter binding_getter3 = new VTDObjectGetter(pi5);
            VTDPropertyInfoBase pi6 = new VTDPropertyInfoBase("Url");
            VTDBaseSetter binding_setter3 = new VTDObjectSetter(pi6);
            binding_setter3 = new StringFormaterDecorator(binding_setter3,"{Step.RESTInputProperties.RESTActivityV24.Date}");
            bind_dir3 = new BindDirection(_flow.RESTActivityV24,binding_getter3,binding_setter3,BindTargetType.ToInProperty);
            _flow.RESTActivityV24.InDirections.Add(bind_dir3);
